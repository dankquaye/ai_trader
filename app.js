...
window.updateTradeHistory = (history, totalProfit, wins, losses) => {
    ...
    if (history.length === 0) {
        ui.historyTable.innerHTML = '<tr><td colspan="7" class="text-center py-8 text-gray-500"><i class="fa-solid fa-folder-open text-2xl mb-2 block"></i>No trade history yet</td></tr>';
        return;
    }
